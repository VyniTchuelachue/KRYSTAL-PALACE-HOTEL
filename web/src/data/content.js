...
export const navSections = [
  {
    ...
    anchor: '#chambres',
    cta: { label: 'Explorer toutes les chambres', anchor: '#chambres' },
    items: [
      { name: 'Chambre Classic', image: '/img/room-01.jpg', anchor: '#chambres' },
      { name: 'Chambre Premium Plus', image: '/img/room-02.jpg', anchor: '#chambres' },
      { name: 'Chambre Deluxe', image: '/img/room-03.jpg', anchor: '#chambres' },
      { name: 'Meugang Suite', image: '/img/room-06.jpg', anchor: '#chambres' },
      { name: 'Mandela Suite', image: '/img/room-07.jpg', anchor: '#chambres' },
    ],
  },
  {
    id: 'restauration',
    ...
    anchor: '#restauration',
    cta: { label: 'Découvrir la table et le spa', anchor: '#restauration' },
    items: [
      { name: 'Restaurant & Cafétéria', image: '/img/dining-canapes.jpg', anchor: '#restauration' },
      { name: 'Krystal Spa', image: '/img/spa.jpg', anchor: '#bien-etre' },
      { name: 'Piscine & Terrasse', image: '/img/terrace.jpg', anchor: '#bien-etre' },
    ],
  },
  {
    id: 'evenements',
    label: 'Événements',
    anchor: '#evenements',
    cta: { label: 'Organiser un événement', anchor: '#evenements' },
    items: [
      { name: 'Mariages', image: '/img/wedding.jpg', anchor: '#evenements' },
      { name: 'Séminaires & Réceptions', image: '/img/event-dinner.jpg', anchor: '#evenements' },
      { name: 'Espace Enfants', image: '/img/kids.jpg', anchor: '#evenements' },
    ],
  },
  {
    id: 'hotel',
    label: 'Notre Hôtel',
    anchor: '#hotel',
    cta: { label: 'En savoir plus sur nous', anchor: '#hotel' },
    items: [
      { name: 'Notre histoire', image: '/img/african-decor.jpg', anchor: '#hotel' },
      { name: 'Douala & ses environs', image: '/img/lounge-sunset.jpg', anchor: '#emplacement' },
      { name: 'Galerie photos', image: '/img/lobby-1.jpg', anchor: '#galerie' },
    ],
  },
]

export const simpleLinks = [
  { label: 'Avis clients', anchor: '#avis' },
  { label: 'Emplacement', anchor: '#emplacement' },
