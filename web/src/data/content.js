...
export const navSections = [
  {
    ...
    items: [
      { name: 'Chambre Twin', image: '/img/nav-room-twin.jpg', to: '/chambres' },
      { name: 'Chambre Classic', image: '/img/nav-room-classic.jpg', to: '/chambres' },
      { name: 'Chambre Premium', image: '/img/nav-room-premium.jpg', to: '/chambres' },
      { name: 'Chambre Deluxe', image: '/img/nav-room-deluxe.jpg', to: '/chambres' },
      { name: 'Suite Executive', image: '/img/nav-suite-executive.jpg', to: '/chambres' },
      { name: 'Suite Prestige', image: '/img/nav-suite-prestige.jpg', to: '/chambres' },
      { name: 'Meugang Suite', image: '/img/nav-suite-meugang.jpg', to: '/chambres' },
      { name: 'Mandela Suite', image: '/img/nav-suite-mandela.jpg', to: '/chambres' },
    ],
  },
  {
    id: 'restauration',
    ...
    items: [
      { name: 'Restaurant', image: '/img/nav-restaurant.jpg', to: '/restauration' },
      { name: 'Cafétéria & Buffet', image: '/img/nav-cafeteria.jpg', to: '/restauration' },
      { name: 'Cuisine gastronomique', image: '/img/nav-cuisine.jpg', to: '/restauration' },
      { name: 'Jacuzzi & Détente', image: '/img/nav-jacuzzi.jpg', to: '/bien-etre' },
      { name: 'Krystal Spa', image: '/img/nav-spa.jpg', to: '/bien-etre' },
      { name: 'Piscine & Terrasse', image: '/img/nav-pool.jpg', to: '/bien-etre' },
      { name: 'Sport & Fitness', image: '/img/nav-fitness.jpg', to: '/bien-etre' },
    ],
  },
  {
    id: 'evenements',
    ...
    items: [
      { name: 'Mariages', image: '/img/nav-wedding.jpg', to: '/evenements' },
      { name: 'Séminaires', image: '/img/nav-seminar.jpg', to: '/evenements' },
      { name: 'Réceptions', image: '/img/nav-reception.jpg', to: '/evenements' },
    ],
  },
  {
    id: 'hotel',
...
export const featuredRooms = [
  ...
  },
  {
    ...
    surface: '30 m²',
    capacity: '2 pers.',
    image: '/img/nav-room-classic.jpg',
  ...
  },
  {
    ...
    surface: '30 m²',
    capacity: '2 pers.',
    image: '/img/nav-room-premium.jpg',
  ...
  },
  {
    ...
    surface: '65 m²',
    capacity: '2 pers.',
    image: '/img/nav-suite-executive.jpg',
  ...
  },
  {
    ...
    surface: '65 m²',
    capacity: '2 pers.',
    image: '/img/nav-suite-prestige.jpg',
    description: 'Une suite aux volumes généreux, pensée pour un séjour placé sous le signe du prestige.',
  },
  {
    name: 'Meugang Suite',
    surface: '110 m²',
    capacity: '2 pers.',
    image: '/img/nav-suite-meugang.jpg',
  ...
  },
  {
    ...
    surface: '160 m²',
    capacity: '2 pers.',
    image: '/img/nav-suite-mandela.jpg',
...
export const homeFeatures = [
  {
    ...
    images: [
      { src: '/img/room-suite-attends.jpg', alt: 'Chambre du Krystal Palace Douala', caption: 'Chambres & Suites' },
      { src: '/img/nav-room-twin.jpg', alt: 'Twin Room', caption: 'Twin Room' },
      { src: '/img/nav-room-classic.jpg', alt: 'Classic Room', caption: 'Classic Room' },
      { src: '/img/nav-room-premium.jpg', alt: 'Premium Room', caption: 'Premium Room' },
      { src: '/img/nav-room-deluxe.jpg', alt: 'Deluxe Room', caption: 'Deluxe Room' },
      { src: '/img/nav-suite-executive.jpg', alt: 'Executive Suite', caption: 'Executive Suite' },
      { src: '/img/nav-suite-prestige.jpg', alt: 'Prestige Suite', caption: 'Prestige Suite' },
      { src: '/img/nav-suite-meugang.jpg', alt: 'Meugang Suite', caption: 'Meugang Suite' },
      { src: '/img/nav-suite-mandela.jpg', alt: 'Mandela Suite', caption: 'Mandela Suite' },
    ],
    imageSide: 'right',
    dark: false,
  },
  {
    ...
    images: [
      { src: '/img/nav-restaurant.jpg', alt: 'Salle du restaurant', caption: 'Le restaurant' },
      { src: '/img/nav-cafeteria.jpg', alt: 'Buffet et viennoiseries de la cafétéria', caption: 'Cafétéria & Buffet' },
      { src: '/img/nav-cuisine.jpg', alt: 'Assiette gastronomique', caption: 'Cuisine gastronomique' },
    ],
    imageSide: 'left',
    dark: true,
  },
  {
    ...
    images: [
      { src: '/img/nav-pool.jpg', alt: 'Piscine et terrasse', caption: 'Piscine & Terrasse' },
      { src: '/img/nav-spa.jpg', alt: 'Soin relaxant au Krystal Spa', caption: 'Krystal Spa' },
      { src: '/img/nav-jacuzzi.jpg', alt: 'Jacuzzi', caption: 'Jacuzzi & Détente' },
      { src: '/img/nav-fitness.jpg', alt: 'Cours de fitness', caption: 'Sport & Fitness' },
    ],
    imageSide: 'right',
    dark: false,
  },
  {
    ...
    images: [
      { src: '/img/nav-wedding.jpg', alt: 'Table de mariage', caption: 'Mariages' },
      { src: '/img/nav-seminar.jpg', alt: 'Salle de séminaire', caption: 'Séminaires' },
      { src: '/img/nav-reception.jpg', alt: 'Réception au bord de la piscine', caption: 'Réceptions' },
    ],
    imageSide: 'left',
    dark: false,
  },
...
export const galleryImages = [
  ...
  { src: '/img/nav-room-twin.jpg', alt: 'Twin Room', category: 'Chambres' },
  { src: '/img/nav-room-classic.jpg', alt: 'Classic Room', category: 'Chambres' },
  { src: '/img/nav-room-premium.jpg', alt: 'Premium Room', category: 'Chambres' },
  { src: '/img/nav-room-deluxe.jpg', alt: 'Deluxe Room', category: 'Chambres' },
  { src: '/img/nav-suite-executive.jpg', alt: 'Executive Suite', category: 'Chambres' },
  { src: '/img/nav-suite-prestige.jpg', alt: 'Prestige Suite', category: 'Chambres' },
  { src: '/img/nav-suite-meugang.jpg', alt: 'Meugang Suite', category: 'Chambres' },
  { src: '/img/nav-suite-mandela.jpg', alt: 'Mandela Suite', category: 'Chambres' },
